...
contract('rocketPoolCrowdsale', function (accounts) {
    ...
    it(printTitle('userFirst', 'fails to allows deposits to begin'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                // Transaction
                return rocketPoolCrowdsaleInstance.setSaleDepositsAllowed(true, { from: userFirst, to: rocketPoolCrowdsaleInstance.address, gas: 250000 }).then(function (result) {
                    return result;
                }).then(function (result) {
                    assert(false, "Expect throw but didn't.");
                }).catch(function (error) {
    ...
    // Owner allows sales to begin
    it(printTitle('owner', 'allows deposits to begin'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                // Transaction
                return rocketPoolCrowdsaleInstance.setSaleDepositsAllowed(true, { from: owner, to: rocketPoolCrowdsaleInstance.address, gas: 250000 }).then(function (result) {
                    // Get the contribution balance of their account now
                    return rocketPoolCrowdsaleInstance.saleDepositsAllowed.call().then(function (result) {
                        return result.valueOf();
                    }).then(function (result) {
                        assert.isTrue(result, "Deposits allowed to begin successfully.");
                    });
                });
            });
        });
    ...
    it(printTitle('userFirst', 'makes successful deposit to crowdsale of 1 ether - total deposit size: 1 ether'), function () {
        // Crowdsale contract   
        return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
            // Contribute amount
            var sendAmount = web3.toWei('1', 'ether'); 
    ...
    it(printTitle('userFirst', 'makes another successful deposit at the maxiumum allowed at 2 ether - total deposit size: 3 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
    ...
    it(printTitle('userSecond', 'deposits at the maxiumum allowed in a single transaction (2 ether), this meets the targetEth require for the sale, depositAddress receives funds - total deposit size: 5 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
    ...
    it(printTitle('userThird', 'makes successful deposit to crowdsale of 1.33333945012327 ether - total deposit size: 6.33333945012327 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                ...
                // Contribute amount
                var sendAmount = web3.toWei('1.33333945012327', 'ether');
                // Transaction
    ...
    it(printTitle('userFourth', 'makes successful deposit to crowdsale of 0.5 ether - total deposit size: 6.83333945012327 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
    ...
    it(printTitle('userSixth', 'makes successful deposit to crowdsale of 1 ether - total deposit size: 7.83333945012327 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
    ...
    it(printTitle('owner', 'verify total contribution size - 7.83333945012327 ether'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                // Contribute amount
                var contributionTotal = web3.toWei('7.83333945012327', 'ether');
                // Get the contribution balance of their account now
                return rocketPoolCrowdsaleInstance.contributedTotal.call().then(function (result) {
                    return result.valueOf() == contributionTotal ? true : false;
                }).then(function (result) {
                    assert.isTrue(result, "Contribution total matches.");
                });
            });
        });
    }); // End Test   
    ...
    // Owner ends public sale
    it(printTitle('owner', 'closes deposits and allows token withdrawals + refunds to begin'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                // Transaction
                return rocketPoolCrowdsaleInstance.setSaleDepositsAllowed(false, { from: owner, to: rocketPoolCrowdsaleInstance.address, gas: 250000 }).then(function (result) {
                    // Get the contribution balance of their account now
                    return rocketPoolCrowdsaleInstance.saleDepositsAllowed.call().then(function (result) {
                        return result.valueOf();
                    }).then(function (result) {
                        assert.isFalse(result, "Deposits closed successfully.");
                    });
                });
            });
        });
    ...
    it(printTitle('userFourth', 'fails to make deposit to crowdsale of 0.5 ether as crowdsale deposits are finished'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
                        ...
                        return rocketPoolTokenInstance.getSaleContractTokensLimit.call(rocketPoolCrowdsaleInstance.address).then(function (result) {
                            ...
                            return rocketPoolCrowdsaleInstance.getContributionOf.call(userFirst).then(function (result) {
                                ...
                                return rocketPoolTokenInstance.balanceOf.call(userFirst).then(function (result) {
                                    ...
                                    //console.log((tokenTotalAfter / exponent).toFixed(6));
                                    //console.log(Number(web3.fromWei(refund, 'ether')).toFixed(6));
                                    ...
                                    return userFirstBalanceAfter > userFirstBalance &&
                                        ...
                                        Number(web3.fromWei(refund, 'ether')).toFixed(6) == Number('1.085108') 
                                        ? true : false;
                                }).then(function (result) {
    ...
    it(printTitle('userSixth', 'fails to trigger owner method for triggering release of a users tokens'), function () {
        // Token contract   
        return rocketPoolToken.deployed().then(function (rocketPoolTokenInstance) {
            // Crowdsale contract   
            return rocketPoolCrowdsale.deployed().then(function (rocketPoolCrowdsaleInstance) {
